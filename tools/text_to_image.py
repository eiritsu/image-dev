...
class TextToImageTool(Tool):
    def _invoke(self, tool_parameters: dict[str, Any]) -> Generator[ToolInvokeMessage]:
        ...
        # 验证参数
        self._validate_parameters(width, height, steps, cfg_scale, n)
    ...
    def _validate_parameters(self, width, height, steps, cfg_scale, n):
        """
        验证输入参数
        """
        # 验证图像尺寸
    ...
    def _call_third_party_api(self, api_url, api_key, model, task_type, prompt, negative_prompt, image_url, width, height, steps, cfg_scale, seed, n):
        """
        调用第三方AI平台API生成图像
        """
